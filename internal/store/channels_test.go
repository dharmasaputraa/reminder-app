...
func TestChannelOwnerScope(t *testing.T) {
	...
	// owner A tidak bisa toggle/hapus channel milik B (IDOR)
	...
	// owner B kelola channel sendiri: boleh
	...
	// admin (ownerID 0) bisa toggle + hapus channel milik siapa pun,
	// konsisten dengan konvensi 0=admin di GetChannel/ListChannels
	...
	// channel benar-benar terhapus: B hapus lagi → ErrNotFound
